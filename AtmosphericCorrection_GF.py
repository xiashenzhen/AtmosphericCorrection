...
def Block(IDataSet):
    ...
    for m in range(1, 5):
        ...
        try:
            with tqdm(
                total=XBlockcount * YBlockcount, iterable="iterable", desc="第%i波段:" % m
            ) as pbar:
                ...
                while i < rows:
                    while j < cols:
                        ...
                        y = np.where(
                            outImage != -9999, AtcCofa * outImage - AtcCofb, -9999
                        )
                        atcImage = np.where(
                            y != -9999, (y / (1 + y * AtcCofc)) * 10000, -9999
                        )
...
def RadiometricCalibration(BandId):
    ...
    if SensorID[0:3] == "WFV":
        ...
        Gain_ = config["Parameter"][SatelliteID][SensorID][Year][ImageType]["gain"][
            BandId - 1
        ]
        Bias_ = config["Parameter"][SatelliteID][SensorID][Year][ImageType]["offset"][
            BandId - 1
        ]
...
if __name__ == "__main__":
    ...
    InputFilePath = "/home/tq/vtmp/test_GF"
    OutputFilePath = "/home/tq/vtmp/test_GF/L2"
    tarFiles = [
        "/home/tq/vtmp/test_GF/GF2_PMS1_E103.4_N38.3_20171111_L1A0002756999.tar.gz"
    ]
    for tarFile in tarFiles:
        ...
        if fileType == "GF":
            ...
            if GFType == "WFV":
                ...
                tiffFile = "/home/tq/vtmp/test_GF/GF2_PMS1_E103.4_N38.3_20171111_L1A0002756999/GF2_PMS1_E103.4_N38.3_20171111_L1A0002756999-MSS1.tiff"
            ...
            print(cols, rows, SatelliteID, SensorID, Year, ImageType)
